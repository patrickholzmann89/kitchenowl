...
import 'package:kitchenowl/cubits/recipe_pdf_scraper_cubit.dart';
...
class RecipePdfScraperPage extends StatefulWidget {
  final NamedByteArray file;
  final Household household;

  const RecipePdfScraperPage({
    super.key,
    required this.file,
  ...
  @override
  _RecipePdfScraperPageState createState() => _RecipePdfScraperPageState();
}

class _RecipePdfScraperPageState extends State<RecipePdfScraperPage> {
  late RecipePdfScraperCubit cubit;

  @override
  void initState() {
    super.initState();
    cubit = RecipePdfScraperCubit(widget.household, widget.file);
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocProvider.value(
        value: cubit,
        child: BlocBuilder<RecipePdfScraperCubit, RecipeScraperState>(
          bloc: cubit,
