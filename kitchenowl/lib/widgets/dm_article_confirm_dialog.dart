...
class DmArticleConfirmDialog extends StatefulWidget {
  final DmArticle article;

  const DmArticleConfirmDialog({super.key, required this.article});

  @override
  State<DmArticleConfirmDialog> createState() =>
      _DmArticleConfirmDialogState();
}

class _DmArticleConfirmDialogState extends State<DmArticleConfirmDialog> {
